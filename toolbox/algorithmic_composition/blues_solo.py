...
licks = [ [[1,0.5],[1,0.5],[1, 0.5],[1, 0.5]], [[-1, 0.5],[-1, 0.5],[-1, 0.5],[-1, 0.5]], [[-2, 0.5],[1, 0.5],[-2, 0.5],[1, 0.5]], [[2, 0.5],[-1, 0.5],[2, 0.5],[-1, 0.5]], [[-2, 0.5],[-2, 0.5],[2, 0.5],[1, 0.5]], [[-2, 0.5],[-2, 0.5],[2, 0.5],[2, 0.5]] ]

for i in range(6):
    licks_indices = [0, 1, 2, 3, 4, 5]
    lick = licks[choice(licks_indices)]
    for note in lick:
        curr_note += note[0]
        if curr_note <0:
            curr_note += randint(1,5)
